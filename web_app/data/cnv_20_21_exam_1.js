window.examConfig = {
    title: "Dashboard / My courses / AVExe76220202021 / General / CNV-20-21-Exam-1 / Preview",
    timeLimit: 80
};
...
window.examData = [
  ...
  },
  {
    ...
    "note": "Note:<br>partially correct - Requests are sent to the servers elastically created to deploy the application.<br>(servers are elastically created but requests are sent to the servers already running the application)."
  },
  {
    "number": 3,
    ...
    "marks": 1.0,
    "marks_text": "Marked out of 1.00",
    "note": "Note: Constant Pool creates indirection. Most constant values are not stored in the bytecode itself, therefore access/execution cannot be faster due to (as an advantage of) CP."
  },
  {
    "number": 4,
  ...
  },
  {
    ...
    "marks": 1.0,
    "marks_text": "Marked out of 1.00",
    "note": "Note:<br>- Mapper process is run for each input split (three small files are three input splits), map function is going to be executed 3 times.<br>- By default, there is only one reducer process.<br>- The reducer function is called once for each distinct key produced during mapping (and given as argument all tuples sharing that same key)."
  },
  {
    "number": 7,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "c",
        "text": "It employes a copying GC in the mature space to handle long-lived objects and to prevent fragmentation."
      },
      {
        "id": "d",
        "text": "<strong><strong>No response (no penalty if only option answered).</strong></strong>"
  ...
  },
  {
    ...
    "marks": 1.0,
    "marks_text": "Marked out of 1.00",
    "note": "Note: 1 correct and 1 incorrect answer awards half the points of a correct option."
  },
  {
    "number": 13,
  ...
  },
  {
    ...
    "options": [
      ...
      {
        "id": "e",
        "text": "Flink can be set up manage a sliding window of 200 second of length and 1 second of sliding interval, and that is event-time based, i.e., to take into account the exact time each message was published."
      }
    ],
    "is_multi": true,
    "correct_ids": [
    ...
    "marks": 1.0,
    "marks_text": "Marked out of 1.00",
    "note": "Note: the central aspect to reflect variations in tuple counts, with significance, as soon as possible, is to have as small as possible window length."
  },
  {
    "number": 21,
    ...
    "options": [
      {
        "id": "a",
        "text": "aload_0<br>iconst_1<br>iaload"
      },
      {
        "id": "b",
        "text": "<strong><strong>No response (no penalty if only option answered).</strong></strong>"
      ...
      {
        "id": "c",
        "text": "fload_1<br>iconst_2<br>faload"
      },
      {
        "id": "d",
        "text": "aload_1<br>iconst_2<br>iaload"
      },
      {
        "id": "e",
        "text": "iload_1<br>iconst_1<br>iaload"
      }
    ],
    "is_multi": false,
    "correct_ids": [
