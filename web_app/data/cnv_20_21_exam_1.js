...
window.examData = [
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Application state in static variables is very limited."
    },
    {
        "number": 3,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Simpler decoding and memory savings."
    },
    {
        "number": 4,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Write availability is ensured using vector-clocks whose size does not adapt to update rates."
    },
    {
        "number": 6,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "There are going to be 3 Mappers and 1 Reducer processes., The map function is going to be called 3 times and the reduce function is going to be called 6 times."
    },
    {
        "number": 7,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "It divides the heap in two zones and wastes half of memory in one of them."
    },
    {
        "number": 9,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "In load balancing with HTTP redirection, when a front-end server fails, there is a long delay for 1/m of new user sessions."
    },
    {
        "number": 12,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Inst_A does not prevent ISA_X from being well-behaved., Inst_A and Inst_D can be executed in system-mode."
    },
    {
        "number": 13,
        ...
        "explanation": "- dimension such as [AutoScalingGroup]\n- is the [metric] returned\n- values or other [statistic] applied\n- according to a given [unit]"
    },
    {
        "number": 14,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Availability., Cost of data transfer."
    },
    {
        "number": 15,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Direct threading has worse code portability than indirect threading., Direct threading has faster steady-state performance than indirect threading."
    },
    {
        "number": 17,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "In Type-1, the Virtual Machine Monitor (VMM) controls the memory mappings in order to carry out memory virtualization., In Type-1 and Type-2, the Virtual Machine Monitor (VMM) is in charge of virtualizing the CPU."
    },
    {
        "number": 18,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Methods shorter than calling sequence may be inlined in every location they are invoked., Using call-graph to identify methods to be inlined incurs in higher overhead."
    },
    {
        "number": 20,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "aload_0 / iconst_1 / iaload"
    },
    {
        "number": 22,
    ...
    },
    {
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Dynamic and resident."
    },
    {
        "number": 24,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Higher elasticity., More fine-grained billing."
    },
    {
        "number": 25,
        ...
        "fill_in_blanks": [],
        "distractors": [],
        "explanation": "Spark has special support for the reuse (e.g., iterative, interactive) of working sets., Spark allows in-memory processing."
    }
];
